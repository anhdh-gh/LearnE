import '../assets/css/WordCardSlide.css'
        ...
        <Carousel controls={false} indicators={false} interval={null} activeIndex={index} variant="dark" className="cart">
            {
                wordCards.map((wordCard, index) => 
                    <Carousel.Item key={index} onClick={() => setIsFipped(isFlipped => !isFlipped)}>
                        <ReactCardFlip isFlipped={isFlipped} flipDirection="horizontal">
                            ...
                            `}>
                                ...
                                <AudioWord 
                                    ...
                                    word={{...wordCard.key, type: 'key', text: wordCard.key.text, info: wordCard.key.info}}
                                />
                            </div>
                            ...
                            `}>
                                ...
                                <AudioWord 
                                    className="fs-4 ps-2 align-self-start" 
                                    word={{...wordCard.value, text: wordCard.value.text, type: 'value', info: wordCard.value.info}}
                                />
                            </div>
                        </ReactCardFlip>
                    </Carousel.Item>
